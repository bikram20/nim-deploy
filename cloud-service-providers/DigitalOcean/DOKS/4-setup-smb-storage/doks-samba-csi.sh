...
# For a basic 1cpu/2gb droplet with 250GB DO volume, we get around ~218MB/s of sequential read/write performance. This should be good enough for our use case (storing model files).
